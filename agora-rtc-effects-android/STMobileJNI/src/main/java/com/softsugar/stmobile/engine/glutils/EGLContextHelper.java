...
public class EGLContextHelper {
    ...
    public void initEGL() throws Exception {
        ...
        STLogUtils.i(DEBUG_TAG, "GL version = " + curGLVersion[0] + "."
                + curGLVersion[1]);
...
//        }
    ...
    public void release() {
        ...
        STLogUtils.i(DEBUG_TAG, "GL Cleaned up");
    }
    ...
    public boolean eglSwapBuffers(){
        return mEGL.eglSwapBuffers(mGLDisplay, mGLSurface);
    }
    ...
    public void initEGLWithSurfaceTexture(SurfaceTexture surfaceTexture) throws Exception {
        mEGL = (EGL10) GLDebugHelper.wrap(EGLContext.getEGL(),
                GLDebugHelper.CONFIG_CHECK_GL_ERROR
                        | GLDebugHelper.CONFIG_CHECK_THREAD,  null);
        ...
        mGLSurface = mEGL.eglCreateWindowSurface(mGLDisplay, mGLConfig, surfaceTexture, null);
        ...
        if (mGLSurface == null || mGLSurface == EGL10.EGL_NO_SURFACE) {
            throw new Exception("Couldn't create new surface");
        }
