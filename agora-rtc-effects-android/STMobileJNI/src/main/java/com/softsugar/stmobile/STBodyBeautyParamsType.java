...
public class STBodyBeautyParamsType {
    ...
    public final static int ST_BEAUTIFY_BODY_REF_PART = 0;           /// \~Chinese 按美体部位的比例调节
    public final static int ST_BEAUTIFY_BODY_REF_HEAD = 1;           /// \~Chinese 按头的比例去调节对应美体部位

    /// \~Chinese 美体输入、输出纹理为RGBA格式
    public final static int ST_BODY_BEAUTIFY_TEX_RGBA = 0;
    /// \~Chinese 美体输入、输出纹理为YUV格式（目前只在Android手机上支持）
