...
public class STFaceAttribute {
    ...
    public static class Attribute {
        String category; // \~Chinese 属性描述, 如"age", "gender", "attractive"
        String label; //\~Chinese 属性标签描述， 如"male", "female"，"35"等
        float score; //\~Chinese 该属性标签的置信度
