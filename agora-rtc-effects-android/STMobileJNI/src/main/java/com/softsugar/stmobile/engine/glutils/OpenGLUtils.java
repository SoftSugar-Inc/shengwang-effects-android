...
public class OpenGLUtils {
	...
	public static int loadProgram(final String strVSource, final String strFSource) {
        ...
        if (iVShader == 0) {
            STLogUtils.i("Load Program", "Vertex Shader Failed");
            return 0;
        }
        iFShader = loadShader(strFSource, GLES20.GL_FRAGMENT_SHADER);
        if (iFShader == 0) {
            STLogUtils.i("Load Program", "Fragment Shader Failed");
            return 0;
        }
        ...
        if (link[0] <= 0) {
            STLogUtils.i("Load Program", "Linking Failed");
            return 0;
        }
...
//		GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, 0);
	...
	public static void textureToByteBuffer(int textureId, int width, int height, ByteBuffer buffer) {
	...
	public static byte[] readPixel(int textureId, int width, int height) {
		if (textureId == OpenGLUtils.NO_TEXTURE) return null;
