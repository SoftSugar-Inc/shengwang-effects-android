...
extern "C" {
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileGreenScreenSegmentNative_createInstance(JNIEnv * env, jobject obj);
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileGreenScreenSegmentNative_process(JNIEnv * env, jobject obj, jobject imageObj, jint outputTexture);
    JNIEXPORT void JNICALL Java_com_softsugar_stmobile_STMobileGreenScreenSegmentNative_destroyInstance(JNIEnv * env, jobject obj);
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileGreenScreenSegmentNative_setParam(JNIEnv * env, jobject obj, jint type, jfloat value);
    JNIEXPORT jfloat JNICALL Java_com_softsugar_stmobile_STMobileGreenScreenSegmentNative_getParam(JNIEnv * env, jobject obj, jint type);
};
