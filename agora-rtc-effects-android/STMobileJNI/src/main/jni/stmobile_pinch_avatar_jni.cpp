...
extern "C"{
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_createInstance(JNIEnv * env, jobject obj, jint config);
//    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_createInstanceFromAssetFile(JNIEnv * env, jobject obj, jstring model_path, jobject assetManager);
JNIEXPORT void JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_destroyInstance(JNIEnv * env, jobject obj);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_loadBasePackage(JNIEnv * env, jobject obj, jstring path, jintArray packageId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_loadBasePackageFromAssetFile(JNIEnv * env, jobject obj, jstring path, jobject assetManager, jintArray packageId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_setAvatarVisiable(JNIEnv * env, jobject obj, jboolean visiable);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_autoPinchFace(JNIEnv * env, jobject obj, jint imageWidth, jint imageHeight, jint rotate, jobject humanAction, jboolean isMale);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_getFaceFeatures(JNIEnv * env, jobject obj, jint featureIdx);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_loadBoneTransformConfig(JNIEnv * env, jobject obj, jstring path);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_updateBoneControllerInfo(JNIEnv * env, jobject obj, jobjectArray controllers, jint count);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_loadBoneTransformConfigFromAssetFile(JNIEnv * env, jobject obj, jstring path, jobject assetManager);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_changeSkinColor(JNIEnv * env, jobject obj, jobject color);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_addFeature(JNIEnv * env, jobject obj, jstring path, jintArray featureId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_setFeatureVisiable(JNIEnv * env, jobject obj, jint featureId, jboolean visiable);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_addFeatureFromAssetFile(JNIEnv * env, jobject obj, jstring path, jobject assetManager, jintArray featureId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_changeFeatureColor(JNIEnv * env, jobject obj, jint featureId, jobject color);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_removeFeature(JNIEnv * env, jobject obj, jint featureId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_clearFeatures(JNIEnv * env, jobject obj);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_addMakeUp(JNIEnv * env, jobject obj, jstring path, jintArray makeupId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_addMakeUpFromAssetFile(JNIEnv * env, jobject obj, jstring path, jobject assetManager, jintArray makeupId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_changeMakeUpColor(JNIEnv * env, jobject obj, jint makeupId, jobject color);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_removeMakeUp(JNIEnv * env, jobject obj, jint makeupId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_clearMakeUps(JNIEnv * env, jobject obj);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_setFacingMode(JNIEnv * env, jobject obj, jint faceMode);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_rotate(JNIEnv * env, jobject obj, jfloat rotateAngle);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_getFacingMode(JNIEnv * env, jobject obj);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_exportPinchConfig(JNIEnv * env, jobject obj, jstring exportJsonPath);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_getPinchConfigBufferLength(JNIEnv * env, jobject obj, jintArray bufferLength, jint dataFormat);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_exportPinchConfigToBuffer(JNIEnv * env, jobject obj, jbyteArray outputBuffer, jint dataFormat);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_loadPinchConfig(JNIEnv * env, jobject obj, jstring configPath);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_loadPinchConfigFromAsset(JNIEnv * env, jobject obj, jstring path, jobject assetManager, jint dataFormat);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_loadPinchConfigFromBuffer(JNIEnv * env, jobject obj, jbyteArray buffer, jint len, jint dataFormat);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_loadAnimationClip(JNIEnv * env, jobject obj, jstring path, jintArray clipId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_unloadAnimationClip(JNIEnv * env, jobject obj, jint clipId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_loadAnimationClipFromAssetsFile(JNIEnv * env, jobject obj, jstring path, jobject assetManager, jintArray clipId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_playAnimationStack(JNIEnv * env, jobject obj, jobjectArray targets);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_getAnimationClipCount(JNIEnv * env, jobject obj);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_changeAnimation(JNIEnv * env, jobject obj, jint clipId, jfloat transitSec);
JNIEXPORT void JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_stopAnimation(JNIEnv * env, jobject obj);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_setDisplayMode(JNIEnv * env, jobject obj, jint displayMode);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_getDisplayMode(JNIEnv * env, jobject obj);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_processTexture(JNIEnv * env, jobject obj, jobject humanActionNativeObj, jint textureInput, jint imageWidth, jint imageHeight, jint rotate, jobject humanAction, jint textureOutput);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_processTexture2(JNIEnv * env, jobject obj, jlong humanActionNativeHandle, jlong humanActionNativeResult, jint textureInput, jint imageWidth, jint imageHeight, jint rotate, jint textureOutput);
JNIEXPORT void JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_resetBodyPose(JNIEnv * env, jobject obj);
JNIEXPORT jlong JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_getDetectConfig(JNIEnv * env, jobject obj);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_setBackgroundFromBuffer(JNIEnv * env, jobject obj, jbyteArray imageData, jint backgroundType, jintArray backgroundId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_setBackgroundColor(JNIEnv * env, jobject obj, jobject color);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_setBackgroundFromPath(JNIEnv * env, jobject obj, jstring path, jintArray backgroundId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_removeBackground(JNIEnv * env, jobject obj, jint backgroundId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_setCameraLookAt(JNIEnv * env, jobject obj, jfloatArray position, jfloatArray target, jfloatArray up, jfloat transitSec);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_setCameraPerspective(JNIEnv * env, jobject obj, jfloat fov, jfloat aspect, jfloat znear, jfloat zfar);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_setCameraOrthogonal(JNIEnv * env, jobject obj, jfloat left, jfloat right, jfloat bottom, jfloat top, jfloat znear, jfloat zfar);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_lockFaceFittingCamera(JNIEnv * env, jobject obj, jboolean lock);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_resetFacePose(JNIEnv * env, jobject obj, jint postType);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_addAvatar(JNIEnv * env, jobject obj, jstring avatarPath, jintArray avatarId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_addAvatarFromBuffer(JNIEnv * env, jobject obj, jstring avatarPath, jobject assetManager, jintArray avatarId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_removeAvatar(JNIEnv * env, jobject obj, int avatarId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_rotateAvatar(JNIEnv * env, jobject obj, float angle);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_translateAvatar(JNIEnv * env, jobject obj, jfloatArray translate);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_scaleAvatar(JNIEnv * env, jobject obj, jfloatArray scale);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_activeAvatar(JNIEnv * env, jobject obj, jint activeId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_cloneAvatar(JNIEnv * env, jobject obj, jint srcAvatarId, jintArray avatarId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_freezeFeatureDynamicBone(JNIEnv * env, jobject obj, jint featureId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_loadGenfaceConfig(JNIEnv * env, jobject obj, jstring modelPath, jstring configPath, jstring pinchModelPath);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_loadGenfaceConfigFromBuffer(JNIEnv * env, jobject obj, jobject assetManager, jstring modelPath, jstring configPath, jstring pinchModelPath);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_genFace(JNIEnv * env, jobject obj, jbyteArray data, jint format, jint imageWidth, jint imageHeight, jint rotate, jobject humanAction, jboolean isMale, jint avatarId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_genPinchFaceBlendShapeCount(JNIEnv * env, jobject obj);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_resetGenFace(JNIEnv * env, jobject obj, jint avatarId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_unloadGenfaceConfig(JNIEnv * env, jobject obj);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_setFittingScale(JNIEnv *env, jobject obj, jint part, jfloat scale);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_setUpbodyIkEnabled(JNIEnv *env, jobject obj, jboolean enable);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_getEyebrowType(JNIEnv *env, jobject obj);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_addAsset(JNIEnv * env, jobject obj, jstring path, jintArray assetId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_changeAssetColor(JNIEnv * env, jobject obj, jint makeupId, jobjectArray color, int count);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_addAssetFromAssetFile(JNIEnv * env, jobject obj, jstring path, jobject assetManager, jintArray assetId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_removeAsset(JNIEnv * env, jobject obj, jint assetId);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_removeAllAsset(JNIEnv * env, jobject obj);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_genPinchFaceBoneCount(JNIEnv * env, jobject obj);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_getAutoPinchResult(JNIEnv * env, jobject obj, jint imageWidth, jint imageHeight, jint rotate, jobject humanAction, jboolean isMale,
...
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_getFaceExpression(JNIEnv *env, jobject obj, jint width, jint height, jint rotate, jobject humanActionObj, jfloatArray values);
JNIEXPORT jobjectArray JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_calcStandardPose(JNIEnv *env, jobject obj, jint width, jint height, jint rotate, jobject humanAction, jfloat fov);
};
...
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_loadPinchConfigFromBuffer(JNIEnv * env, jobject obj, jbyteArray buffer, jint len, jint dataFromat)
{
...
bool convert2STGenAvatarTexture(JNIEnv *env, jobject texObject, st_mobile_texture_t *avatar_texture) {
    jclass clazz = env->FindClass("com/softsugar/stmobile/params/STGenAvatarTexture");

    jfieldID fieldID = env->GetFieldID(clazz, "id", "I");

    avatar_texture->id = env->GetIntField(texObject, fieldID);

    jfieldID fieldWidth = env->GetFieldID(clazz, "width", "I");
    avatar_texture->width = env->GetIntField(texObject, fieldWidth);

    jfieldID fieldHeight = env->GetFieldID(clazz, "height", "I");
    avatar_texture->height = env->GetIntField(texObject, fieldHeight);

    jfieldID fieldFormat = env->GetFieldID(clazz, "format", "I");
    avatar_texture->format = static_cast<st_pixel_format>(env->GetIntField(texObject, fieldFormat));

    env->DeleteLocalRef(clazz);
    return true;
}

jobject convert2STGenAvatarTexture(JNIEnv *env, const st_mobile_texture_t *avatar_texture) {
    jclass clazz = env->FindClass("com/softsugar/stmobile/params/STGenAvatarTexture");
    jobject textureObj = env->AllocObject(clazz);

    jfieldID fieldId = env->GetFieldID(clazz, "id", "I");
    env->SetIntField(textureObj, fieldId, avatar_texture->id);

    jfieldID fieldWidth = env->GetFieldID(clazz, "width", "I");
    env->SetIntField(textureObj, fieldWidth, avatar_texture->width);

    jfieldID fieldHeight = env->GetFieldID(clazz, "height", "I");
    env->SetIntField(textureObj, fieldHeight, avatar_texture->height);

    jfieldID fieldFormat = env->GetFieldID(clazz, "format", "I");
    env->SetIntField(textureObj, fieldFormat, (int) avatar_texture->format);
    return textureObj;
}

bool convert2GenAvatarOutParam(JNIEnv *env, jobject outObject, st_gen_avatar_out_param_t *out_param) {
    if (outObject == NULL) {
        return false;
    }
    jclass clazz = env->FindClass("com/softsugar/stmobile/params/STGenAvatarOutParam");

    // tex
    jfieldID fieldTex = env->GetFieldID(clazz, "tex", "Lcom/softsugar/stmobile/params/STGenAvatarTexture;");
    jobject texObject = env->GetObjectField(outObject, fieldTex);
    if (texObject != NULL) {
        out_param->p_tex = new st_mobile_texture_t;
        memset(out_param->p_tex, 0, sizeof(st_mobile_texture_t));
        convert2STGenAvatarTexture(env, texObject, out_param->p_tex);
    }

    env->DeleteLocalRef(texObject);
    env->DeleteLocalRef(clazz);
    return true;
}

bool convert2BlendShapeFactory(JNIEnv *env, jobject inputObject, st_blend_shape_factor_t *blend_shape) {
    if (inputObject == NULL) {
        return false;
    }
    ...
    blend_shape->count = env->GetIntField(inputObject, fieldCount);

    int count = blend_shape->count;
    // p_blend_shapes 表情基数组
    jfieldID fieldBlendShapes = env->GetFieldID(clazz, "blendShapes", "[F");
    jfloatArray ShapeArray = (jfloatArray) env->GetObjectField(inputObject, fieldBlendShapes);
    jfloat *mat_elems = env->GetFloatArrayElements(ShapeArray, 0);
    blend_shape->p_blend_shapes = new float[count];
    for (int i=0;i<count;i++) {
        blend_shape->p_blend_shapes[i] = mat_elems[i];
    }

    // region
    jfieldID fieldRegion = env->GetFieldID(clazz, "region", "I");
    blend_shape->region = static_cast<st_blend_shape_region>(env->GetIntField(inputObject, fieldRegion));

    env->DeleteLocalRef(clazz);
    return true;
}
bool convert2GenAvatarInParam(JNIEnv *env, jobject inputObject, st_gen_avatar_in_param_t *in_param) {
    if (inputObject == NULL) {
        return false;
    }
    jclass clazz = env->FindClass("com/softsugar/stmobile/params/STGenAvatarInParam");

    // p_tex
    jfieldID fieldTex = env->GetFieldID(clazz, "tex", "Lcom/softsugar/stmobile/params/STGenAvatarTexture;");
    jobject texObject = env->GetObjectField(inputObject, fieldTex);
    if (texObject != NULL) {
        in_param->p_tex = new st_mobile_texture_t ;
        memset(in_param->p_tex, 0, sizeof(st_mobile_texture_t));
        convert2STGenAvatarTexture(env, texObject, in_param->p_tex);
    }

    // humanAction
    jfieldID fieldHuman = env->GetFieldID(clazz, "human", "Lcom/softsugar/stmobile/model/STHumanAction;");
    jobject humanObject = env->GetObjectField(inputObject, fieldHuman);
    in_param->p_human = new st_mobile_human_action_t;
    memset(in_param->p_human, 0, sizeof(st_mobile_human_action_t));
    if (!convert2HumanAction(env, humanObject, in_param->p_human)) {
        memset(in_param->p_human, 0, sizeof(st_mobile_human_action_t));
    }

    // bodyAvatarCount
    jfieldID fieldBodyAvatarCount = env->GetFieldID(clazz, "bodyAvatarCount", "I");
    in_param->body_avatar_count = env->GetIntField(inputObject, fieldBodyAvatarCount);

    // p_blend_factor
    jfieldID fieldBlendFactor = env->GetFieldID(clazz, "blendFactor", "Lcom/softsugar/stmobile/params/STBlendShapeFactory;");
    jobject blendFactorObject = env->GetObjectField(inputObject, fieldBlendFactor);

    in_param->p_blend_factor = new st_blend_shape_factor_t;
    if (!convert2BlendShapeFactory(env, blendFactorObject, in_param->p_blend_factor)) {
        memset(in_param->p_blend_factor, 0, sizeof(st_blend_shape_factor_t));
    }

    // rotate
    jfieldID fieldRotate = env->GetFieldID(clazz, "rotate", "I");
    in_param->rotate = static_cast<st_rotate_type>(env->GetIntField(inputObject,
                                                                    fieldRotate));
    env->DeleteLocalRef(clazz);
    return true;
}

void convert2GenAvatarOutParam(JNIEnv *env, const st_gen_avatar_out_param_t *out_param, jobject outParamObject) {
    jclass clazz =env->FindClass("com/softsugar/stmobile/params/STGenAvatarOutParam");

    jfieldID fieldTex = env->GetFieldID(clazz, "tex", "Lcom/softsugar/stmobile/params/STGenAvatarTexture;");
    jobject txObj = convert2STGenAvatarTexture(env, out_param->p_tex);
    env->SetObjectField(outParamObject, fieldTex, txObj);
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_softsugar_stmobile_STMobilePinchAvatarNative_processTextureExtended(JNIEnv *env,
                                                                             jobject obj,
                                                                             jobject in_param,
                                                                             jobject out_param) {
    int result = ST_JNI_ERROR_DEFAULT;
    ...
    st_gen_avatar_in_param_t *input = new st_gen_avatar_in_param_t;

    convert2GenAvatarInParam(env, in_param, input);
    st_mobile_body_avatar_t* body_avatar = {0};
    input->p_body_avatar_array = body_avatar;
    st_gen_avatar_out_param_t *output = new st_gen_avatar_out_param_t;
    convert2GenAvatarOutParam(env, out_param, output);

    input->body_avatar_count = 1;
    result = st_mobile_gen_avatar_process_texture_extended(avatarhandle, input, output);
    convert2GenAvatarOutParam(env, output, out_param);

    delete output;
    output = NULL;
    releaseHumanAction(input->p_human);
    delete input;
    input = NULL;
    return result;
}
...
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_getActivedAvatar(JNIEnv * env, jobject obj, jintArray activeId){
    int result = ST_JNI_ERROR_DEFAULT;
    st_handle_t avatarHandle = getPinchAvatarHandle(env, obj);
...
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_setFittingScale(JNIEnv *env, jobject obj,
...
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_setUpbodyIkEnabled(JNIEnv *env, jobject obj,
                                                                                                jboolean enable) {
...
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_changeAssetColor(JNIEnv * env, jobject obj, jint assetId, jobjectArray colors, int count){
    int result = ST_JNI_ERROR_DEFAULT;
    st_handle_t avatarHandle = getPinchAvatarHandle(env, obj);
...
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_getFaceExpression(JNIEnv *env, jobject obj, jint width, jint height, jint rotate, jobject humanAction, jfloatArray values) {
    int result = ST_JNI_ERROR_DEFAULT;
    st_handle_t avatarHandle = getPinchAvatarHandle(env, obj);
...
JNIEXPORT jobjectArray JNICALL Java_com_softsugar_stmobile_STMobilePinchAvatarNative_calcStandardPose(JNIEnv *env, jobject obj, jint width, jint height, jint rotate, jobject humanAction, jfloat fov) {
    ...
    if(result == ST_OK){
        jclass transform_cls = env->FindClass("com/softsugar/stmobile/model/STTransform");
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_softsugar_stmobile_STMobilePinchAvatarNative_setOption(JNIEnv *env, jobject thiz,
