...
extern "C" {
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileAvatarNative_createInstance(JNIEnv * env, jobject obj, jstring modelpath);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileAvatarNative_createInstanceFromAssetFile(JNIEnv * env, jobject obj, jstring model_path, jobject assetManager);
JNIEXPORT void JNICALL Java_com_softsugar_stmobile_STMobileAvatarNative_destroyInstance(JNIEnv * env, jobject obj);
JNIEXPORT jlong JNICALL Java_com_softsugar_stmobile_STMobileAvatarNative_getAvatarDetectConfig(JNIEnv * env, jobject obj);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileAvatarNative_avatarExpressionDetect(JNIEnv * env, jobject obj, jint rotate, jint imageWidth, jint imageHeight, jobject humanActionInput, jfloatArray outputArray);
}
...
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileAvatarNative_createInstance(JNIEnv * env, jobject obj, jstring modelpath)
{
    ...
    int result = -1;//st_mobile_avatar_create(&ha_handle, modelpathChars);
    if(result != 0){
...
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileAvatarNative_createInstanceFromAssetFile(JNIEnv * env, jobject obj, jstring model_path, jobject assetManager){
    ...
    int result = -1;//st_mobile_avatar_create_from_buffer(&handle, buffer, size);
    if(buffer){
        delete[] buffer;
        buffer = NULL;
    }
...
JNIEXPORT jlong JNICALL Java_com_softsugar_stmobile_STMobileAvatarNative_getAvatarDetectConfig(JNIEnv * env, jobject obj)
{
    ...
    if(avatarhandle != NULL)
    {
        result = -1;//st_mobile_avatar_get_detect_config(avatarhandle);
    }
    return result;
}
...
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileAvatarNative_avatarExpressionDetect(JNIEnv * env, jobject obj, jint rotate, jint imageWidth, jint imageHeight, jobject humanActionInput, jfloatArray outputArray)
{
    ...
    if(avatarhandle != NULL)
    {
        ...
        result = -1;//st_mobile_avatar_get_expression(avatarhandle, imageWidth, imageHeight, (st_rotate_type)rotate, &human_face_input, outArray);
