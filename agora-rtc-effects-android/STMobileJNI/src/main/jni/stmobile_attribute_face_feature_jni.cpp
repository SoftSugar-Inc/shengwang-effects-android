...
extern "C" {
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileAttributeFaceFeatureNative_createInstance(JNIEnv * env, jobject obj, jstring modelpath);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileAttributeFaceFeatureNative_createInstanceFromAssetFile(JNIEnv * env, jobject obj, jstring model_path, jobject assetManager);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_createInstanceWithSubModels(JNIEnv * env, jobject obj, jobjectArray modelPaths, jint modelCount);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileAttributeFaceFeatureNative_addSubModel(JNIEnv * env, jobject obj, jstring modelpath);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileAttributeFaceFeatureNative_addSubModelFromAssetFile(JNIEnv * env, jobject obj, jstring model_path, jobject assetManager);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileAttributeFaceFeatureNative_removeSubModelByConfig(JNIEnv * env, jobject obj, jint config);
JNIEXPORT jobject JNICALL Java_com_softsugar_stmobile_STMobileAttributeFaceFeatureNative_faceFeaturesDetect(JNIEnv * env, jobject obj, jobject face, jint gender, jint faceCount, jbyteArray pInputImage, jint imageFormat,
                                                                                                            jlong face_feature_config, jint rotate, jint imageWidth, jint imageHeight);
JNIEXPORT void JNICALL Java_com_softsugar_stmobile_STMobileAttributeFaceFeatureNative_destroyInstance(JNIEnv * env, jobject obj);
};
...
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileAttributeFaceFeatureNative_createInstanceWithSubModels(JNIEnv * env, jobject obj, jobjectArray modelPaths, jint modelCount)
{
