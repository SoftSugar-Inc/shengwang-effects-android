...
bool convert2STRect(JNIEnv *env, jobject inputObject, st_rect_t *st_rect) {
    if (inputObject == NULL) {
        return false;
    }
    jclass render_in_param_class = env->FindClass("com/softsugar/stmobile/model/STEffectRenderInParam");

    jfieldID fieldSTRect = env->GetFieldID(render_in_param_class, "targetFaceSTRect", "Lcom/softsugar/stmobile/model/STRect;");

    jobject stRectObject = env->GetObjectField(inputObject, fieldSTRect);
    if (stRectObject == NULL) {
        env->DeleteLocalRef(render_in_param_class);
        env->DeleteLocalRef(stRectObject);
        return false;
    }
    jclass clazz = env->FindClass("com/softsugar/stmobile/model/STRect");
    jfieldID fieldLeft = env->GetFieldID(clazz, "left", "I");
    st_rect->left = env->GetIntField(stRectObject, fieldLeft);

    jfieldID fieldTop = env->GetFieldID(clazz, "top", "I");
    st_rect->top = env->GetIntField(stRectObject, fieldTop);

    jfieldID fieldRight = env->GetFieldID(clazz, "right", "I");
    st_rect->right = env->GetIntField(stRectObject, fieldRight);

    jfieldID fieldBottom = env->GetFieldID(clazz, "bottom", "I");
    st_rect->bottom = env->GetIntField(stRectObject, fieldBottom);
...
jobject convert2STRect(JNIEnv *env, const st_rect_t &object_rect){
    jclass STRectClass = env->FindClass("com/softsugar/stmobile/model/STRect");
...
jobject convert2MobileFace106(JNIEnv *env, const st_mobile_106_t &mobile_106){
    jclass st_mobile_106_class = env->FindClass("com/softsugar/stmobile/model/STMobile106");
    jfieldID frect = env->GetFieldID(st_mobile_106_class, "rect", "Lcom/softsugar/stmobile/model/STRect;");
    jfieldID fscore = env->GetFieldID(st_mobile_106_class, "score", "F");
    jfieldID fpoints_array = env->GetFieldID(st_mobile_106_class, "points_array", "[Lcom/softsugar/stmobile/model/STPoint;");
    ...
    jclass st_mobile_point_class = env->FindClass("com/softsugar/stmobile/model/STPoint");
    jfieldID fpoint_x = env->GetFieldID(st_mobile_point_class, "x", "F");
    jfieldID fpoint_y = env->GetFieldID(st_mobile_point_class, "y", "F");

    jclass st_face_rect_class = env->FindClass("com/softsugar/stmobile/model/STRect");
...
jobject convert2FaceAttribute(JNIEnv *env, const st_mobile_attributes_t *faceAttribute){
    jclass face_attribute_cls = env->FindClass("com/softsugar/stmobile/model/STFaceAttribute");

    jfieldID fieldAttribute_count = env->GetFieldID(face_attribute_cls, "attribute_count", "I");
    jfieldID fieldAttribute = env->GetFieldID(face_attribute_cls, "arrayAttribute", "[Lcom/softsugar/stmobile/model/STFaceAttribute$Attribute;");
    ...
    jclass attribute_cls = env->FindClass("com/softsugar/stmobile/model/STFaceAttribute$Attribute");
...
jobject convert2Image(JNIEnv *env, const st_image_t *image){
    jclass image_cls = env->FindClass("com/softsugar/stmobile/model/STImage");
    ...
    if(image->pixel_format == ST_PIX_FMT_RGBA8888 || image->pixel_format == ST_PIX_FMT_BGRA8888){
        size = size * 4;
    }
    jbyteArray arrayImageData;
    arrayImageData = (env)->NewByteArray(size);
    jbyte* data = (jbyte*)(image->data);
    if(data == NULL){
        return NULL;
    }
    env->SetByteArrayRegion(arrayImageData, 0, size, data);
...
jobject convert2Segment(JNIEnv *env, const st_mobile_segment_t *segment){
    jclass segment_cls = env->FindClass("com/softsugar/stmobile/model/STSegment");

    jfieldID fieldImage = env->GetFieldID(segment_cls, "image", "Lcom/softsugar/stmobile/model/STImage;");
    ...
    jfieldID fieldOffset = env->GetFieldID(segment_cls, "offset", "Lcom/softsugar/stmobile/model/STPoint;");
    jfieldID fieldScale = env->GetFieldID(segment_cls, "scale", "Lcom/softsugar/stmobile/model/STPoint;");
    ...
    jclass st_points_class = env->FindClass("com/softsugar/stmobile/model/STPoint");
...
jobject convert2HandInfo(JNIEnv *env, const st_mobile_hand_t *hand_info){
    jclass hand_info_cls = env->FindClass("com/softsugar/stmobile/model/STMobileHandInfo");

    jfieldID fieldHandId = env->GetFieldID(hand_info_cls, "handId", "I");
    jfieldID fieldHandRect = env->GetFieldID(hand_info_cls, "handRect", "Lcom/softsugar/stmobile/model/STRect;");
    jfieldID fieldKeyPoints = env->GetFieldID(hand_info_cls, "keyPoints", "[Lcom/softsugar/stmobile/model/STPoint;");
    ...
    jfieldID fieldExtra2dKeyPoints = env->GetFieldID(hand_info_cls, "extra2dKeyPoints", "[Lcom/softsugar/stmobile/model/STPoint;");
    jfieldID fieldExtra3dKeyPoints = env->GetFieldID(hand_info_cls, "extra3dKeyPoints", "[Lcom/softsugar/stmobile/model/STPoint3f;");
    ...
    jfieldID fieldHandDynamicGesture = env->GetFieldID(hand_info_cls, "dynamicGesture", "Lcom/softsugar/stmobile/model/STHandDynamicGesture;");
    jfieldID fieldGestureKeyPoints = env->GetFieldID(hand_info_cls, "gestureKeyPoints", "[Lcom/softsugar/stmobile/model/STPoint;");
    ...
    jclass hand_rect_class = env->FindClass("com/softsugar/stmobile/model/STRect");
    ...
    jclass st_point3f_class = env->FindClass("com/softsugar/stmobile/model/STPoint3f");
    ...
    jclass st_dynamic_gesture_class = env->FindClass("com/softsugar/stmobile/model/STHandDynamicGesture");
...
jobject convert2FootInfo(JNIEnv *env, const st_mobile_foot_t *foot_info){
    jclass hand_info_cls = env->FindClass("com/softsugar/stmobile/model/STMobileFoot");
...
jobject convert2BodyInfo(JNIEnv *env, const st_mobile_body_t *body_info){
    jclass body_info_cls = env->FindClass("com/softsugar/stmobile/model/STMobileBodyInfo");

    jfieldID fieldId = env->GetFieldID(body_info_cls, "id", "I");
    jfieldID fieldKeyPoints = env->GetFieldID(body_info_cls, "keyPoints", "[Lcom/softsugar/stmobile/model/STPoint;");
    ...
    jfieldID fieldContourPoints = env->GetFieldID(body_info_cls, "contourPoints", "[Lcom/softsugar/stmobile/model/STPoint;");
    ...
    jfieldID fieldKeyPoints3d = env->GetFieldID(body_info_cls, "keyPoints3d", "[Lcom/softsugar/stmobile/model/STPoint3f;");
...
jobject convert2FaceInfo(JNIEnv *env, st_mobile_face_t *face_info){
    jclass face_info_cls = env->FindClass("com/softsugar/stmobile/model/STMobileFaceInfo");

    jfieldID fieldFace = env->GetFieldID(face_info_cls, "face106", "Lcom/softsugar/stmobile/model/STMobile106;");

    jfieldID fieldExtraFacePoints = env->GetFieldID(face_info_cls, "extraFacePoints", "[Lcom/softsugar/stmobile/model/STPoint;");
    jfieldID fieldExtraFacePointsCount = env->GetFieldID(face_info_cls, "extraFacePointsCount", "I");

    jfieldID fieldTonguePoints = env->GetFieldID(face_info_cls, "tonguePoints", "[Lcom/softsugar/stmobile/model/STPoint;");
    ...
    jfieldID fieldEyeballCenter = env->GetFieldID(face_info_cls, "eyeballCenter", "[Lcom/softsugar/stmobile/model/STPoint;");
    jfieldID fieldEyeballCenterPointsCount = env->GetFieldID(face_info_cls, "eyeballCenterPointsCount", "I");

    jfieldID fieldEyeballContour = env->GetFieldID(face_info_cls, "eyeballContour", "[Lcom/softsugar/stmobile/model/STPoint;");
    ...
    jfieldID fieldFaceExtraInfo = env->GetFieldID(face_info_cls, "faceExtraInfo", "Lcom/softsugar/stmobile/model/STFaceExtraInfo;");
    ...
    jfieldID fieldHairColor = env->GetFieldID(face_info_cls, "hairColor", "Lcom/softsugar/stmobile/model/STColor;");
    jfieldID fieldSkinType = env->GetFieldID(face_info_cls, "skin_type", "I");

    jfieldID fieldFaceMesh = env->GetFieldID(face_info_cls, "faceMesh", "Lcom/softsugar/stmobile/model/STFaceMesh;");

    jfieldID fieldGazeDirection = env->GetFieldID(face_info_cls, "gazeDirection", "[Lcom/softsugar/stmobile/model/STPoint3f;");
    jfieldID fieldGazeScore = env->GetFieldID(face_info_cls, "gazeScore", "[F");

    jfieldID fieldEarInfo = env->GetFieldID(face_info_cls, "earInfo", "Lcom/softsugar/stmobile/model/STMobileEarInfo;");
    jfieldID fieldForeheadInfo = env->GetFieldID(face_info_cls, "foreheadInfo", "Lcom/softsugar/stmobile/model/STMobileForeheadInfo;");

    jobject faceInfoObj = env->AllocObject(face_info_cls);

    //face106
    jclass face106Class = env->FindClass("com/softsugar/stmobile/model/STMobile106");
    ...
    //avatar extra info
    jclass extraClass = env->FindClass("com/softsugar/stmobile/model/STFaceExtraInfo");
    ...
    //hair color
    jclass color_class = env->FindClass("com/softsugar/stmobile/model/STColor");
    ...
    // p_face_pose
    jfieldID fieldFacePose = env->GetFieldID(face_info_cls, "facePose", "Lcom/softsugar/stmobile/params/ST3DPose;");
    jobject stFacePoseObj = convert2STST3DPose(env, face_info->p_face_pose);
    if (NULL!=stFacePoseObj)
        env->SetObjectField(faceInfoObj, fieldFacePose, stFacePoseObj);

    // p_face_blend_shapes
    jfieldID fieldExpressionCount = env->GetFieldID(face_info_cls, "blendShapesCount", "I");
    env->SetIntField(faceInfoObj, fieldExpressionCount, face_info->blend_shapes_count);
    // p_expression_array
    jfieldID fieldExpressionArray = env->GetFieldID(face_info_cls, "faceBlendShapes", "[F");
    jfloatArray expression_array = env->NewFloatArray(face_info->blend_shapes_count);
    env->SetFloatArrayRegion(expression_array, 0, face_info->blend_shapes_count, face_info->p_face_blend_shapes);
    env->SetObjectField(faceInfoObj, fieldExpressionArray, expression_array);
    env->DeleteLocalRef(expression_array);
...
jobject convert2HumanActionSegments(JNIEnv *env, const st_mobile_human_action_segments_t *human_action_segments){
    jclass human_action_segment_cls = env->FindClass("com/softsugar/stmobile/model/STHumanActionSegments");

    jfieldID fieldImage = env->GetFieldID(human_action_segment_cls, "image", "Lcom/softsugar/stmobile/model/STSegment;");

    jfieldID fieldHair = env->GetFieldID(human_action_segment_cls, "hair", "Lcom/softsugar/stmobile/model/STSegment;");
    jfieldID fieldSkin = env->GetFieldID(human_action_segment_cls, "skin", "Lcom/softsugar/stmobile/model/STSegment;");
    jfieldID fieldHead = env->GetFieldID(human_action_segment_cls, "head", "Lcom/softsugar/stmobile/model/STSegment;");
    jfieldID fieldMouthParse = env->GetFieldID(human_action_segment_cls, "mouthParses", "[Lcom/softsugar/stmobile/model/STSegment;");
    ...
    jfieldID fieldSky = env->GetFieldID(human_action_segment_cls, "sky", "Lcom/softsugar/stmobile/model/STSegment;");
    jfieldID fieldDepth = env->GetFieldID(human_action_segment_cls, "depth", "Lcom/softsugar/stmobile/model/STSegment;");

    jfieldID fieldFaceOcclusion = env->GetFieldID(human_action_segment_cls, "faceOcclusions", "[Lcom/softsugar/stmobile/model/STSegment;");
    jfieldID fieldFaceOcclusionCount = env->GetFieldID(human_action_segment_cls, "faceOcclusionCount", "I");

    jfieldID fieldMultiSegment = env->GetFieldID(human_action_segment_cls, "multiSegment", "Lcom/softsugar/stmobile/model/STSegment;");

    jobject humanActionSegmentObj = env->AllocObject(human_action_segment_cls);

    //image
    if(human_action_segments->p_figure != NULL){
        jclass segmentClass = env->FindClass("com/softsugar/stmobile/model/STSegment");
    ...
    jclass faceOccClass = env->FindClass("com/softsugar/stmobile/model/STSegment");
    ...
    jclass mouthParseClass = env->FindClass("com/softsugar/stmobile/model/STSegment");
...
jobject convert2HumanAction(JNIEnv *env, const st_mobile_human_action_t *human_action){
    ...
    jclass human_action_cls = env->FindClass("com/softsugar/stmobile/model/STHumanAction");

    jfieldID fieldFaces = env->GetFieldID(human_action_cls, "faces", "[Lcom/softsugar/stmobile/model/STMobileFaceInfo;");
    jfieldID fieldFaceCount = env->GetFieldID(human_action_cls, "faceCount", "I");

    jfieldID fieldFeets = env->GetFieldID(human_action_cls, "feets", "[Lcom/softsugar/stmobile/model/STMobileFoot;");
    jfieldID fieldFootCount = env->GetFieldID(human_action_cls, "footCount", "I");

    jfieldID fieldHands = env->GetFieldID(human_action_cls, "hands", "[Lcom/softsugar/stmobile/model/STMobileHandInfo;");
    jfieldID fieldHandCount = env->GetFieldID(human_action_cls, "handCount", "I");

    jfieldID fieldBodys = env->GetFieldID(human_action_cls, "bodys", "[Lcom/softsugar/stmobile/model/STMobileBodyInfo;");
    jfieldID fieldBodyCount = env->GetFieldID(human_action_cls, "bodyCount", "I");

    jfieldID fieldHeads = env->GetFieldID(human_action_cls, "heads", "[Lcom/softsugar/stmobile/model/STMobileHeadInfo;");
    jfieldID fieldHeadCount = env->GetFieldID(human_action_cls, "headCount", "I");

    jfieldID fieldSegments = env->GetFieldID(human_action_cls, "humanActionSegments", "Lcom/softsugar/stmobile/model/STHumanActionSegments;");
    ...
    jclass foot_info_cls = env->FindClass("com/softsugar/stmobile/model/STMobileFoot");
    ...
    jclass head_info_cls = env->FindClass("com/softsugar/stmobile/model/STMobileHeadInfo");
    ...
    if(human_action->p_segments != NULL){
        jclass segmentClass = env->FindClass("com/softsugar/stmobile/model/STHumanActionSegments");
        jobject segment_object = env->AllocObject(segmentClass);
...
jobject convert2AnimalFace(JNIEnv *env, const st_mobile_animal_face_t *animal_face){
    ...
    jfieldID fieldRect = env->GetFieldID(animal_face_cls, "rect", "Lcom/softsugar/stmobile/model/STRect;");
    jfieldID fieldScore = env->GetFieldID(animal_face_cls, "score", "F");
    jfieldID fieldKeyPoints = env->GetFieldID(animal_face_cls, "p_key_points", "[Lcom/softsugar/stmobile/model/STPoint;");
    ...
    jclass st_point_class = env->FindClass("com/softsugar/stmobile/model/STPoint");
...
bool convert2HandInfo(JNIEnv *env, jobject handInfoObject, st_mobile_hand_t *hand_info){
    ...
    if(hand_info->skeleton_3d_keypoints_count > 0){
        //3d
        jclass point3_class = env->FindClass("com/softsugar/stmobile/model/STPoint3f");
...
bool convert2FaceInfo(JNIEnv *env, jobject faceInfoObject, st_mobile_face_t *face_info){
    ...
    // count
    jfieldID fieldExpressionCount = env->GetFieldID(face_info_cls, "blendShapesCount", "I");
    face_info->blend_shapes_count = env->GetIntField(faceInfoObject, fieldExpressionCount);

    // array
    jfieldID fieldExpressionArray = env->GetFieldID(face_info_cls, "faceBlendShapes", "[F");
    if (face_info->blend_shapes_count > 0) {
        jfloatArray expression_array = (jfloatArray) env->GetObjectField(faceInfoObject, fieldExpressionArray);
        float *scores = env->GetFloatArrayElements(expression_array, 0);
        face_info->p_face_blend_shapes = new float[face_info->blend_shapes_count];

        // 进行拷贝
        memset(face_info->p_face_blend_shapes, 0, sizeof(float) * face_info->blend_shapes_count);
        memcpy(face_info->p_face_blend_shapes, scores, sizeof(float) * face_info->blend_shapes_count);

        env->ReleaseFloatArrayElements(expression_array, scores, JNI_FALSE);
        env->DeleteLocalRef(expression_array);
    } else {
        face_info->p_face_blend_shapes = NULL;
    }

    // p_face_pose
    jfieldID jfieldPose = env->GetFieldID(face_info_cls, "facePose", "Lcom/softsugar/stmobile/params/ST3DPose;");
    jobject postObj = env->GetObjectField(faceInfoObject, jfieldPose);
    face_info->p_face_pose = new st_3dpose_t();
    if (!convert2STST3DPose(env, postObj, face_info->p_face_pose)) {
        memset(face_info->p_face_pose, 0, sizeof(st_3dpose_t));
        face_info->p_face_pose = NULL;
    }
...
bool convert2HumanActionSegments(JNIEnv *env, jobject humanActionSegmentObject, st_mobile_human_action_segments_t *human_action_segments){
    ...
    jclass human_action_segments_cls = env->FindClass("com/softsugar/stmobile/model/STHumanActionSegments");

    jfieldID fieldImage = env->GetFieldID(human_action_segments_cls, "image", "Lcom/softsugar/stmobile/model/STSegment;");

    jfieldID fieldHair = env->GetFieldID(human_action_segments_cls, "hair", "Lcom/softsugar/stmobile/model/STSegment;");
    jfieldID fieldHead = env->GetFieldID(human_action_segments_cls, "head", "Lcom/softsugar/stmobile/model/STSegment;");
    jfieldID fieldSkin = env->GetFieldID(human_action_segments_cls, "skin", "Lcom/softsugar/stmobile/model/STSegment;");
    jfieldID fieldSky  = env->GetFieldID(human_action_segments_cls, "sky", "Lcom/softsugar/stmobile/model/STSegment;");
    jfieldID fieldMouthParse = env->GetFieldID(human_action_segments_cls, "mouthParses", "[Lcom/softsugar/stmobile/model/STSegment;");
    ...
    jfieldID fieldFaceOcclusion = env->GetFieldID(human_action_segments_cls, "faceOcclusions", "[Lcom/softsugar/stmobile/model/STSegment;");
    jfieldID fieldFaceOcclusionCount = env->GetFieldID(human_action_segments_cls, "faceOcclusionCount", "I");

    jfieldID fieldMultiSegment = env->GetFieldID(human_action_segments_cls, "multiSegment", "Lcom/softsugar/stmobile/model/STSegment;");
...
bool convert2HumanAction(JNIEnv *env, jobject humanActionObject, st_mobile_human_action_t *human_action){
    ...
    jfieldID fieldSegment = env->GetFieldID(human_action_cls, "humanActionSegments", "Lcom/softsugar/stmobile/model/STHumanActionSegments;");
...
jobject convert2FaceExtraInfo(JNIEnv *env, const st_mobile_face_extra_info &face_extra_info){
    jclass face_extra_info_cls = env->FindClass("com/softsugar/stmobile/model/STFaceExtraInfo");
...
bool convert2FaceExtraInfo(JNIEnv *env, jobject faceExtraInfoObject, st_mobile_face_extra_info *face_extra_info){
    ...
    jclass face_info_cls = env->FindClass("com/softsugar/stmobile/model/STFaceExtraInfo");
...
bool convert2YuvImage(JNIEnv *env, jobject yuvImageObj, st_multiplane_image_t *yuv_image){
    ...
    jclass yuv_image_cls = env->FindClass("com/softsugar/stmobile/model/STYuvImage");
...
void releaseHumanAction(st_mobile_human_action_t * p_human) {
    ...
    safe_delete_array(p_human->p_extra_buffer);
    ...
    if(p_human->p_segments){
        ...
        releaseSegment(p_human->p_segments->p_green, 1);
...
void releaseSegment(st_mobile_segment_t*& p_dst, int count){
    if (nullptr != p_dst) {
        for (int i = 0; i < count; ++i)
        {
            ...
            safe_delete_array(p_dst[i].p_extra_info_buffer);
        }
        delete[] p_dst;
        p_dst = nullptr;
    }
...
jobject convert2Quaternion(JNIEnv *env, const st_quaternion_t &quaternion){
    jclass STQuaternionClass = env->FindClass("com/softsugar/stmobile/model/STQuaternion");
...
jobject convert2FaceMeshList(JNIEnv *env, const st_mobile_face_mesh_list_t *faceMeshList){
    if (faceMeshList == NULL) {
        return NULL;
    }
    jclass face_mesh_list_cls = env->FindClass("com/softsugar/stmobile/model/STFaceMeshList");

    jfieldID fieldFaceMeshList = env->GetFieldID(face_mesh_list_cls, "faceMeshList", "[Lcom/softsugar/stmobile/model/STMeshIndex;");
    jfieldID fieldFaceMeshListCount = env->GetFieldID(face_mesh_list_cls, "faceMeshListCount", "I");

    jclass mesh_index_cls = env->FindClass("com/softsugar/stmobile/model/STMeshIndex");
...
bool convert2FaceMeshIndex(JNIEnv *env, jobject inputObj, st_face_mesh_index_t *face_mesh_index) {
    jclass clazz = env->FindClass("com/softsugar/stmobile/model/STMeshIndex");
...
bool convert2FaceMeshList(JNIEnv *env, jobject inputObject, st_mobile_face_mesh_list_t *face_mesh_list){
    jclass clazz = env->FindClass("com/softsugar/stmobile/model/STFaceMeshList");
    // faceMeshListCount
    ...
    // p_face_mesh_index
    jfieldID jfieldFaceMeshIndexArray = env->GetFieldID(clazz, "faceMeshList", "[Lcom/softsugar/stmobile/model/STMeshIndex;");
...
jobject convert2FaceMesh(JNIEnv *env, const st_mobile_face_mesh_t *faceMesh){
    jclass face_mesh_cls = env->FindClass("com/softsugar/stmobile/model/STFaceMesh");
...
jobject convert2HeadInfo(JNIEnv *env, const st_mobile_head_t *head_info){
    ...
    jfieldID fieldHeadMesh = env->GetFieldID(head_info_cls, "headMesh", "Lcom/softsugar/stmobile/model/STFaceMesh;");
    jfieldID fieldHeadResult = env->GetFieldID(head_info_cls, "headResult", "Lcom/softsugar/stmobile/model/STMobileHeadResultInfo;");
...
jobject convert2HeadResultInfo(JNIEnv *env, const st_mobile_head_result_t *head_result){
    jclass head_result_cls = env->FindClass("com/softsugar/stmobile/model/STMobileHeadResultInfo");

    jfieldID fieldId = env->GetFieldID(head_result_cls, "id", "I");
    jfieldID fieldRect = env->GetFieldID(head_result_cls, "rect", "Lcom/softsugar/stmobile/model/STRect;");
...
bool convert2FaceMesh(JNIEnv *env, jobject faceMeshObj, st_mobile_face_mesh_t *face_mesh){
    ...
    jclass face_mesh_cls = env->FindClass("com/softsugar/stmobile/model/STFaceMesh");
    jfieldID fieldMeshPoints = env->GetFieldID(face_mesh_cls, "meshPoints", "[Lcom/softsugar/stmobile/model/STPoint3f;");
    jfieldID fieldNormalPoints = env->GetFieldID(face_mesh_cls, "normalPoints", "[Lcom/softsugar/stmobile/model/STPoint3f;");
...
bool convert2EarInfo(JNIEnv *env, jobject earInfoObject, st_mobile_ear_t *ear_info){
    ...
    jclass ear_info_cls = env->FindClass("com/softsugar/stmobile/model/STMobileEarInfo");

    jfieldID fieldEarPoints = env->GetFieldID(ear_info_cls, "earPoints", "[Lcom/softsugar/stmobile/model/STPoint;");
...
bool convert2ForeheadInfo(JNIEnv *env, jobject foreheadInfoObject, st_mobile_forehead_t *forehead_info){
    ...
    jclass forehead_info_cls = env->FindClass("com/softsugar/stmobile/model/STMobileForeheadInfo");
    jfieldID fieldForeheadPoints = env->GetFieldID(forehead_info_cls, "foreheadPoints", "[Lcom/softsugar/stmobile/model/STPoint;");
...
jobject convert2Color(JNIEnv *env, const st_color_t *color){
    jclass STColorClass = env->FindClass("com/softsugar/stmobile/model/STColor");
...
//    jclass STBodyAvatarClass = env->FindClass("com/softsugar/stmobile/model/STBodyAvatar");
//    jclass STQuaternionClass = env->FindClass("com/softsugar/stmobile/model/STQuaternion");
//    jfieldID quaternion_x = env->GetFieldID(STQuaternionClass, "x", "F");
//    jfieldID quaternion_y = env->GetFieldID(STQuaternionClass, "y", "F");
//    jfieldID quaternion_z = env->GetFieldID(STQuaternionClass, "z", "F");
...
//
//    jfieldID fieldQuaternions = env->GetFieldID(STBodyAvatarClass, "quaternions", "[Lcom/softsugar/stmobile/model/STBodyAvatar;");
...
jobject convert2STTransform(JNIEnv *env, const st_mobile_transform_t *transform){
    jclass transformClass = env->FindClass("com/softsugar/stmobile/model/STTransform");
...
char *convert2JByteArrayToChars2(JNIEnv *env, jbyteArray byteArray){
    if (byteArray == NULL)
        return NULL;
    char *chars = NULL;
    jbyte *bytes;
...
jobject convert2STST3DPose(JNIEnv *env, const st_3dpose_t *st_pose) {
    if (st_pose == NULL) {
        //LOGE("st_pose is NULL");
        return NULL;
    }
    jclass clazz = env->FindClass("com/softsugar/stmobile/params/ST3DPose");
    jobject poseObj = env->AllocObject(clazz);
    // mat
    jfieldID fieldMat = env->GetFieldID(clazz, "mat", "[F");
    jfloatArray matArray = env->NewFloatArray(16);
    env->SetFloatArrayRegion(matArray, 0, 16, st_pose->mat);
    env->SetObjectField(poseObj, fieldMat, matArray);
    env->DeleteLocalRef(matArray);

    // extra_bits
    jfieldID fieldBits = env->GetFieldID(clazz, "extraBits", "I");
    env->SetIntField(poseObj, fieldBits, (int) st_pose->extra_bits);

    env->DeleteLocalRef(clazz);
    return poseObj;
}

bool convert2STST3DPose(JNIEnv *env, jobject inputObj, st_3dpose_t *st_pose) {
    if(inputObj==NULL) {
        return false;
    }
    jclass clazz = env->FindClass("com/softsugar/stmobile/params/ST3DPose");

    jfieldID fieldExtraBits = env->GetFieldID(clazz, "extraBits", "I");
    st_pose->extra_bits = env->GetIntField(inputObj, fieldExtraBits);

    jfieldID fieldMat = env->GetFieldID(clazz, "mat", "[F");
    jfloatArray matArray = (jfloatArray) env->GetObjectField(inputObj, fieldMat);
    if (NULL!=matArray) {
        jfloat *mat_elems = env->GetFloatArrayElements(matArray, 0);
        int mat_len = env->GetArrayLength(matArray);
        //memset(st_pose->mat, 0, 16);
        //memcpy(st_pose->mat, mat_elems, 16);
        //env->ReleaseFloatArrayElements(matArray, mat_elems, 0);

        // 暂时注释，等发新库再打开
        for (int i = 0; i < 16; i++) {
            st_pose->mat[i] = mat_elems[i];
        }
    }
    env->DeleteLocalRef(clazz);
    return true;
...
//void convert2BlendShapeFactory2(JNIEnv *env, const st_blend_shape_factor_t *blend_shape, jobject blendShapeObject) {
