...
jobject convert2FaceFeature(JNIEnv *env, const st_mobile_attr_face *face_feature, bool isMale){
    jclass face_feature_cls = env->FindClass("com/softsugar/stmobile/model/STAttributeFaceFeature");
    jfieldID fieldEyelidInfo = env->GetFieldID(face_feature_cls, "eyelidInfo", "Lcom/softsugar/stmobile/model/STAttributeEyelidInfo;");
    jfieldID fieldGlassInfo = env->GetFieldID(face_feature_cls, "glassInfo", "Lcom/softsugar/stmobile/model/STAttributeGlassInfo;");
    jfieldID fieldBoyHairInfo = env->GetFieldID(face_feature_cls, "hairBoyInfo", "Lcom/softsugar/stmobile/model/STAttributeBoyHairInfo;");
    jfieldID fieldGirlHairInfo = env->GetFieldID(face_feature_cls, "hairGirlInfo", "Lcom/softsugar/stmobile/model/STAttributeGirlHairInfo;");
    jfieldID fieldIdMustacheInfo = env->GetFieldID(face_feature_cls, "mustacheInfo", "Lcom/softsugar/stmobile/model/STAttributeMustacheInfo;");
    jfieldID fieldBoyEyebrowInfo = env->GetFieldID(face_feature_cls, "eyebrowBoyInfo", "Lcom/softsugar/stmobile/model/STAttributeBoyEyebrowInfo;");
    jfieldID fieldGirlEyebrowInfo = env->GetFieldID(face_feature_cls, "eyebrowGirlInfo", "Lcom/softsugar/stmobile/model/STAttributeGirlEyebrowInfo;");
...
jobject convert2EyelidInfo(JNIEnv *env, const st_mobile_attr_face_eyelid_info *eyelid_info){
    jclass eyelid_info_cls = env->FindClass("com/softsugar/stmobile/model/STAttributeEyelidInfo");
...
jobject convert2GlassInfo(JNIEnv *env, const st_mobile_attr_face_glass_info *glass_info){
    jclass glass_info_cls = env->FindClass("com/softsugar/stmobile/model/STAttributeGlassInfo");
...
jobject convert2BoyHairInfo(JNIEnv *env, const st_mobile_attr_face_hair_boy_info *hair_info){
    jclass hair_info_cls = env->FindClass("com/softsugar/stmobile/model/STAttributeBoyHairInfo");
...
jobject convert2GirlHairInfo(JNIEnv *env, const st_mobile_attr_face_hair_girl_info *hair_info){
    jclass hair_info_cls = env->FindClass("com/softsugar/stmobile/model/STAttributeGirlHairInfo");
...
//    jclass eyebrow_info_cls = env->FindClass("com/softsugar/stmobile/model/STAttributeBoyEyebrowInfo");
...
//    jclass eyebrow_info_cls = env->FindClass("com/softsugar/stmobile/model/STAttributeGirlEyebrowInfo");
//    jfieldID fieldEyebrowThickness = env->GetFieldID(eyebrow_info_cls, "thickness", "I");
//    jfieldID fieldEyebrowShape = env->GetFieldID(eyebrow_info_cls, "shape", "I");
//
//    jobject eyebrowInfoObject = env->AllocObject(eyebrow_info_cls);
...
jobject convert2MustacheInfo(JNIEnv *env, const st_mobile_attr_face_mustache_info *mustache_info){
    jclass mustache_info_cls = env->FindClass("com/softsugar/stmobile/model/STAttributeMustacheInfo");
...
bool convert2Controller(JNIEnv *env, jobject controllerObject, st_bone_controller_info_t *controller){
    ...
    jclass controller_cls = env->FindClass("com/softsugar/stmobile/model/STPCController");
...
bool convert2st_animation_target(JNIEnv *env, jobject animationTargetObject, st_animation_target *animation_target){
    ...
    jclass animation_target_cls = env->FindClass("com/softsugar/stmobile/model/STAnimationTarget");
...
jobject convert2STBoneTransform(JNIEnv *env, const st_mobile_bone_transform_t *transform){
    jclass transformClass = env->FindClass("com/softsugar/stmobile/model/STBoneTransform");
    ...
    jfieldID fieldTransform= env->GetFieldID(transformClass, "transform", "Lcom/softsugar/stmobile/model/STTransform;");
    ...
    jclass tranClass = env->FindClass("com/softsugar/stmobile/model/STTransform");
