...
extern "C" {
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileObjectTrackNative_createInstance(JNIEnv * env, jobject obj);
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileObjectTrackNative_setTarget(JNIEnv * env, jobject obj, jbyteArray pInputImage,
              jint informat, jint imageWidth, jint imageHeight, jobject inputRect);
    JNIEXPORT jobject JNICALL Java_com_softsugar_stmobile_STMobileObjectTrackNative_objectTrack(JNIEnv * env, jobject obj, jbyteArray pInputImage,
            jint informat, jint imageWidth, jint imageHeight, jfloatArray resultScore);
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileObjectTrackNative_reset(JNIEnv * env, jobject obj);
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileObjectTrackNative_destroyInstance(JNIEnv * env, jobject obj);
};
