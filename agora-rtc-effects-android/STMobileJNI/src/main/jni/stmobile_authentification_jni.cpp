...
extern "C" {
JNIEXPORT jstring JNICALL Java_com_softsugar_stmobile_STMobileAuthentificationNative_generateActiveCode(JNIEnv * env, jobject obj, jobject context, jstring licensePath);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileAuthentificationNative_checkActiveCode(JNIEnv * env, jobject obj, jobject context, jstring licensePath, jstring activationCode, jint codeSize);
JNIEXPORT jstring JNICALL Java_com_softsugar_stmobile_STMobileAuthentificationNative_generateActiveCodeFromBuffer(JNIEnv * env, jobject obj, jobject context, jstring licenseBuffer, jint licenseSize);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileAuthentificationNative_checkActiveCodeFromBuffer(JNIEnv * env, jobject obj, jobject context, jstring licenseBuffer, jint licenseSize, jstring activationCode, jint codeSize);
JNIEXPORT jstring JNICALL Java_com_softsugar_stmobile_STMobileAuthentificationNative_generateActiveCodeOnline(JNIEnv * env, jobject obj, jobject context, jstring licenseBuffer, jint licenseSize, jstring activationCode, jint codeSize);
JNIEXPORT jstring JNICALL Java_com_softsugar_stmobile_STMobileAuthentificationNative_generateActiveCodeFromBufferOnline(JNIEnv * env, jobject obj, jobject context, jstring licenseBuffer, jint licenseSize);

JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileAuthentificationNative_getExpiredTimeFromActivateCode(JNIEnv * env, jobject obj, jstring licensePath, jstring activeCodePath, jlongArray valueArray);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileAuthentificationNative_getExpiredTimeFromActivateCodeFromBuffer(JNIEnv * env, jobject obj, jstring licenseBuffer, jint licenseSize, jstring activationCode, jint codeSize, jlongArray valueArray);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileAuthentificationNative_getLicenseExpiredTime(JNIEnv * env, jobject obj, jstring licensePath, jstring activeCodePath, jlongArray startValueArray, jlongArray endValueArray);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileAuthentificationNative_getLicenseExpiredTimeFromBuffer(JNIEnv * env, jobject obj, jstring licenseBuffer, jint licenseSize, jstring activationCode, jint codeSize, jlongArray startValueArray, jlongArray endValueArray);
};
...
JNIEXPORT jstring JNICALL Java_com_softsugar_stmobile_STMobileAuthentificationNative_generateActiveCodeOnline(JNIEnv * env, jobject obj, jobject context, jstring licensePath) {
    LOGI("-->> 111generateActiveCode: start genrate active code");
//    const char *targetProductName = env->GetStringUTFChars(productName, 0);
    const char *targetLicensePath = env->GetStringUTFChars(licensePath, 0);
    char * activationCode = new char[10240];
