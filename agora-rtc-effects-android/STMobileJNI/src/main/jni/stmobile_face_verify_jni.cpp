...
extern "C" {
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileFaceVerifyNative_createInstance(JNIEnv * env, jobject obj, jstring modelPath);
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileFaceVerifyNative_createInstanceFromAssetFile(JNIEnv * env, jobject obj, jstring model_path, jobject assetManager);
    JNIEXPORT jbyteArray JNICALL Java_com_softsugar_stmobile_STMobileFaceVerifyNative_getFeature(JNIEnv * env, jobject obj, jobject pInputImage, jobject face106Array);
    JNIEXPORT float JNICALL Java_com_softsugar_stmobile_STMobileFaceVerifyNative_getFeaturesCompareScore(JNIEnv * env, jobject obj, jbyteArray pFeature_1, jbyteArray pFeature_2);
    JNIEXPORT void JNICALL Java_com_softsugar_stmobile_STMobileFaceVerifyNative_destroyInstance(JNIEnv * env, jobject obj);
}
