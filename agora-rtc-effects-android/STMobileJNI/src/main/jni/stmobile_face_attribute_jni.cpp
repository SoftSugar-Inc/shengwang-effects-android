...
extern "C" {
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileFaceAttributeNative_createInstance(JNIEnv * env, jobject obj, jstring modelpath);
JNIEXPORT int JNICALL Java_com_softsugar_stmobile_STMobileFaceAttributeNative_detect(JNIEnv * env, jobject obj,
...
JNIEXPORT int JNICALL Java_com_softsugar_stmobile_STMobileFaceAttributeNative_detect2(JNIEnv * env, jobject obj,
...
JNIEXPORT int JNICALL Java_com_softsugar_stmobile_STMobileFaceAttributeNative_detect_1ext(JNIEnv * env, jobject obj,
                                                                                          jbyteArray pInputImage, jint imageFormat, jint imageWidth, jint imageHeight, jobjectArray faceArray, jobjectArray arrAttributes);
JNIEXPORT int JNICALL Java_com_softsugar_stmobile_STMobileFaceAttributeNative_detect_1ext2(JNIEnv * env, jobject obj,
                                                                                           jbyteArray pInputImage, jint imageFormat, jint imageWidth, jint imageHeight, jobjectArray faceArray, jobjectArray arrAttributes);
JNIEXPORT void JNICALL Java_com_softsugar_stmobile_STMobileFaceAttributeNative_destroyInstance(JNIEnv * env, jobject obj);
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileFaceAttributeNative_createInstanceFromAssetFile(JNIEnv * env, jobject obj, jstring model_path, jobject assetManager);
}
