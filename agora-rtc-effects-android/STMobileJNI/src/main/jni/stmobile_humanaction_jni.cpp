...
extern "C" {
	JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_createInstance(JNIEnv * env, jobject obj, jstring modelpath, jint config);
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_createInstanceFromAssetFile(JNIEnv * env, jobject obj, jstring model_path, jint config, jobject assetManager);
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_createInstanceFromBuffer(JNIEnv * env, jobject obj, jbyteArray buffer, jint len, jint config);
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_createInstanceWithSubModels(JNIEnv * env, jobject obj, jobjectArray modelPaths, jint modelCount, jint config);
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_addSubModel(JNIEnv * env, jobject obj, jstring modelpath);
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_addSubModelFromAssetFile(JNIEnv * env, jobject obj, jstring model_path, jobject assetManager);
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_addSubModelFromBuffer(JNIEnv * env, jobject obj, jbyteArray buffer, jint len);
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_removeSubModelByConfig(JNIEnv * env, jobject obj, jint config);
	JNIEXPORT jobject JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_humanActionDetect(JNIEnv * env, jobject obj,
	    jbyteArray pInputImage, jint imageFormat, jlong detect_config, jint rotate, jint imageWidth, jint imageHeight);
	JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_reset(JNIEnv * env, jobject obj);
	JNIEXPORT void JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_destroyInstance(JNIEnv * env, jobject obj);
	JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_setParam(JNIEnv * env, jobject obj, jint type, jfloat value);
    JNIEXPORT jbooleanArray JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getExpression(JNIEnv * env, jobject obj, jobject humanAction, jint orientation, jboolean needMirror);
    JNIEXPORT void JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_setExpressionThreshold(JNIEnv * env, jobject obj, jint detectExpression, jfloat threshold);

    JNIEXPORT jobject JNICALL Java_com_softsugar_stmobile_model_STHumanAction_humanActionMirror(JNIEnv * env, jobject obj, jint width, jobject humanAction);
    JNIEXPORT jobject JNICALL Java_com_softsugar_stmobile_model_STHumanAction_humanActionRotate(JNIEnv * env, jobject obj, jint width, jint height, jint orientation, jboolean rotateBackground, jobject humanAction);
    JNIEXPORT jobject JNICALL Java_com_softsugar_stmobile_model_STHumanAction_humanActionResize(JNIEnv * env, jobject obj, jfloat scale, jobject humanAction);
    JNIEXPORT jfloat JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getFaceDistance(JNIEnv * env, jobject obj, jobject faceInfo, jint orientation, jint width, jint height, jfloat fov);
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_setFaceActionThreshold(JNIEnv * env, jobject obj, jlong faceAction, jfloat threshold);
    JNIEXPORT jfloat JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getFaceActionThreshold(JNIEnv * env, jobject obj, jlong config);

    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_nativeHumanActionDetectPtr(JNIEnv * env, jobject obj,
                                                                                                 jbyteArray pInputImage, jint imageFormat, jlong detect_config, jint rotate, jint imageWidth, jint imageHeight);
    JNIEXPORT void JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_nativeHumanActionResizePtr(JNIEnv * env, jobject obj, jfloat scale);
    JNIEXPORT void JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_nativeHumanActionMirrorPtr(JNIEnv * env, jobject obj, jint width);
    JNIEXPORT void JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_nativeHumanActionRotatePtr(JNIEnv * env, jobject obj, jint width, jint height, jint rotation, jboolean rotateBackground);
    
    JNIEXPORT jobject JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getNativeHumanAction(JNIEnv * env, jobject obj);
    JNIEXPORT void JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_nativeHumanActionPtrCopy(JNIEnv * env, jobject obj);
    JNIEXPORT void JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_nativeResizeHumanActionPtr(JNIEnv * env, jobject obj, jfloat scale);

    JNIEXPORT void JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_updateNativeHumanActionCache(JNIEnv * env, jobject obj, jint index);

    JNIEXPORT jobject JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getFaceMeshList(JNIEnv * env, jobject obj);
    JNIEXPORT jintArray JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getFaceMeshList2(JNIEnv * env, jobject obj);
    JNIEXPORT void JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getFaceMeshListQua(JNIEnv * env, jobject obj);
    JNIEXPORT jfloatArray JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getFaceMeshPoint(JNIEnv * env, jobject obj, jint index);
    JNIEXPORT jfloatArray JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getFaceMeshNormal(JNIEnv * env, jobject obj, jint index);

    JNIEXPORT jintArray JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getHeadMeshList2(JNIEnv * env, jobject obj);
    JNIEXPORT jfloatArray JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getHeadMeshPoint(JNIEnv * env, jobject obj, jint index);
    JNIEXPORT jfloatArray JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getHeadMeshNormal(JNIEnv * env, jobject obj, jint index);

    JNIEXPORT jfloatArray JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getFaceMeshTexcoords(JNIEnv * env, jobject obj, jint index);
    JNIEXPORT jintArray JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getFaceOccluderList2(JNIEnv * env, jobject obj);
    JNIEXPORT jfloatArray JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getHeadMeshTexcoords(JNIEnv * env, jobject obj, jint index);
    JNIEXPORT jintArray JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getHeadOccluderList2(JNIEnv * env, jobject obj);
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_loadStandardMeshObj(JNIEnv * env, jobject obj, jstring modelpath, jint mesh_type);
    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_loadStandardMeshObjFromAssetFile(JNIEnv * env, jobject obj, jstring model_path, jint mesh_type, jobject assetManager);
    JNIEXPORT jobject JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_retrieveHumanEdge(JNIEnv * env, jobject obj, jobject imageInput, jint edgeWidth, jboolean edgeBlur);
JNIEXPORT jobject JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getFigureMattingForeground(JNIEnv * env, jobject obj, jlong config);
JNIEXPORT jobjectArray JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_calcUpbodyAvatarQuaternion(JNIEnv * env, jobject obj, jobject humanActionInput, jint imageWidth, jint imageHeight, jint rotate);

    JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getFaceShape(JNIEnv * env, jobject obj, jobject faceIndo, jintArray shapes);
};
...
///////
static inline jfieldID getHumanActionResultCacheField(JNIEnv *env, jobject obj, int index){
    jclass c = env->GetObjectClass(obj);
    if(index == 1){
        return env->GetFieldID(c, "nativeHumanActionCache2", "J");
    }
    return env->GetFieldID(c, "nativeHumanActionCache1", "J");
}

void setHumanActionResultCache(JNIEnv *env, jobject obj, st_mobile_human_action_t * h, int index){
    jlong handle = reinterpret_cast<jlong>(h);
    if(h == nullptr) handle = 0;
    env->SetLongField(obj, getHumanActionResultCacheField(env, obj, index), handle);
}

st_mobile_human_action_t* getHumanActionResultCache(JNIEnv *env, jobject obj, int index){
    jlong handle = env->GetLongField(obj, getHumanActionResultCacheField(env, obj, index));
    if(handle == 0) return nullptr;
    return reinterpret_cast<st_mobile_human_action_t *>(handle);
}
//////
...
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_createInstance(JNIEnv * env, jobject obj, jstring modelpath, jint config)
{
	...
	if (modelpath == NULL) {
        ...
        // 131072=0x00020000
        LOGE("st_mobile_human_action_create config=%d", config);
        if(result != 0){
    ...
    for(int i = 0; i < 2; i++){
        st_mobile_human_action_t* human_action_cache = new st_mobile_human_action_t;
        memset(human_action_cache, 0, sizeof(st_mobile_human_action_t));
        setHumanActionResultCache(env, obj, human_action_cache, i);
    }
...
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_addSubModel(JNIEnv * env, jobject obj, jstring modelpath)
{
    ...
    LOGE("st_mobile_human_action_add_sub_model ret=%d model_path=%s", result, modelpathChars);
...
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_addSubModelFromBuffer(JNIEnv * env, jobject obj, jbyteArray buffer, jint len)
{
    ...
    result = st_mobile_human_action_add_sub_model_from_buffer(handle, (const unsigned char *)srcdata, len);
...
JNIEXPORT jobject JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_humanActionDetect(JNIEnv * env, jobject obj, jbyteArray pInputImage, jint imageFormat,
...
JNIEXPORT void JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_destroyInstance(JNIEnv * env, jobject obj)
{
    ...
    for(int i = 0; i < 2; i++){
        st_mobile_human_action_t* human_action = getHumanActionResultCache(env, obj, i);
        if(human_action != NULL){
            setHumanActionResultCache(env,obj,NULL, i);
            st_mobile_human_action_delete(human_action);
            delete human_action;
            human_action = nullptr;
        }
    }
}
...
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_setParam(JNIEnv * env, jobject obj, jint type, jfloat value)
{
    ...
    LOGE("st_mobile_human_action_setparam type=%d value=%f", type, value);
    return result;
}
...
JNIEXPORT jobject JNICALL Java_com_softsugar_stmobile_model_STHumanAction_humanActionResize(JNIEnv * env, jobject obj,
...
JNIEXPORT jint JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_nativeHumanActionDetectPtr(JNIEnv * env, jobject obj, jbyteArray pInputImage, jint imageFormat,
                                                                                                 jlong detect_config, jint rotate, jint imageWidth, jint imageHeight)
{
    LOGI("humanActionDetect, the width is %d, the height is %d, the rotate is %d",imageWidth, imageHeight, rotate);
    st_handle_t humanActionhandle = getHumanActionHandle(env, obj);
...
{
    st_mobile_human_action_t* human_action = getHumanActionResult(env, obj);
    st_mobile_human_action_t* human_action_out = getHumanActionResultCache(env, obj, index);

    st_mobile_human_action_copy(human_action, human_action_out);
    setHumanActionResultCache(env, obj, human_action_out, index);
}
...
JNIEXPORT jobject JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getFaceMeshList(JNIEnv * env, jobject obj){
    ...
    st_mobile_mesh_info_t face_mesh_list = {0};

    int result = st_mobile_human_action_get_mesh_info(humanActionhandle, ST_MOBILE_FACE_MESH, &face_mesh_list);

    jobject faceMeshList = NULL;
    if(result == ST_OK){
        faceMeshList = convert2FaceMeshList(env, face_mesh_list.p_mesh);
    }
...
JNIEXPORT jintArray JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getFaceMeshList2(JNIEnv * env, jobject obj){
    ...
    jsize arrayLen = face_mesh_list.p_mesh->face_mesh_list_count * 3;
    ...
    for(j = 0; j < elementNum; j++){
        num[i++] = face_mesh_list.p_mesh->p_face_mesh_index[j].v1;
        num[i++] = face_mesh_list.p_mesh->p_face_mesh_index[j].v2;
        num[i++] = face_mesh_list.p_mesh->p_face_mesh_index[j].v3;
    }
...
JNIEXPORT jintArray JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getHeadMeshList2(JNIEnv * env, jobject obj){
    ...
    st_mobile_mesh_info_t face_mesh_list = {0};
    int result = st_mobile_human_action_get_mesh_info(humanActionhandle, ST_MOBILE_HEAD_MESH, &face_mesh_list);
...
JNIEXPORT jintArray JNICALL Java_com_softsugar_stmobile_STMobileHumanActionNative_getFaceOccluderList2(JNIEnv * env, jobject obj){
    ...
    int i = 0, j = 0;
    int elementNum = face_mesh_list.p_mesh->face_mesh_list_count;
...
Java_com_softsugar_stmobile_STMobileHumanActionNative_getMeshList(JNIEnv *env, jobject thiz,
                                                                  jint mesh_type) {
    ...
    int ret = st_mobile_human_action_get_mesh_info(humanActionhandle, (st_mobile_mesh_type)mesh_type, &mesh_mouth_eye_list);

    LOGE("st_mobile_human_action_get_mesh_list ret %d", ret);
    return convert2FaceMeshList(env, mesh_mouth_eye_list.p_mesh);
